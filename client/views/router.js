...
var privateRoutes = [
	...
	"caseprofile.insert",
	"caseprofile.details",
	"caseprofile.details.hearings",
	"caseprofile.details.insert",
	"caseprofile.details.edit",
	"caseprofile.edit",
	"user_settings",
...
Router.map(function () {
	...
	this.route("caseprofileL", {path: "/caseprofileL", controller: "CaseprofileControllerL"});
	...
	this.route("caseprofile.details.insert", {path: "/caseprofile/details/:caseId/insert", controller: "CaseprofileDetailsInsertController"});
	this.route("caseprofile.details.edit", {path: "/caseprofile/details/:caseId/edit/:hearingId", controller: "CaseprofileDetailsEditController"});
	this.route("caseprofile.edit", {path: "/caseprofile/edit/:caseId", controller: "CaseprofileEditController"});
